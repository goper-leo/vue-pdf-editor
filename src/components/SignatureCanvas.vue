...
export default {
    ...
    setup(props, { emit }) {
        ...
        function handlePanStart(event) {
            ...
            data.paths.push(["M", data.x, data.y])
            data.path += `M${data.x},${data.y}`
        }
        ...
        function handlePanMove(event) {
            ...
            data.minY = Math.min(data.minY, data.y)
            data.maxY = Math.max(data.maxY, data.y)
            data.paths.push(["L", data.x, data.y])
            data.path += `L${data.x},${data.y}`
        }
        ...
        return { 
            ...toRefs(data), 
            handlePanEnd, handlePanStart, handlePanMove,
            finish, cancel,
            signatureCanvas
        }
    }
